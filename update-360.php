...
require('connection.php');
    ...
    if(isset($_POST['submit'])){
        ...
        if(isset($_GET['id']) && $_GET['id']!=''){
            ...
            mysqli_query($con, "update rooms set title='$title',room_desc='$room_desc',image='$image' where room_id='$id'");
        }else{
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group">
                            <div class="col-sm-6">
                                <input type="text" class="form-control" name="title" placeholder="Enter title" required value="<?php echo $title; ?>">
                            </div>
                        </div>

                        <div class="form-group">
                            <div class="col-sm-6">
                                <textarea type="text" class="form-control" name="room_desc" placeholder="Enter description" required><?php echo $room_desc; ?></textarea>
                            </div> 
                        </div>
