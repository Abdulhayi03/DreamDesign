<?php
    ...
    if(isset($_POST['submit'])){ 
        ...
        if(isset($_GET['id']) && $_GET['id']!=''){
            ...
            mysqli_query($con, "update projects set category_id='$category_id',pro_title='$pro_title',pro_desc='$pro_desc',pro_thumb='$pro_thumb',pro_type='$pro_type' where pro_id='$id'");
        }else{
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Projects / <span style="color:royalblue;">edit</span></h1>
                    <div class="row">
                        <div class="col-lg-12">
                            <center>
                        ...
                        <div class="form-group">
                            <div class="col-sm-6">
                                <input type="text" class="form-control" name="pro_title" placeholder="Enter project title" required value="<?php echo $pro_title; ?>">
                            </div>
                        </div>

                        <div class="form-group">
                            <div class="col-sm-6">
                                <textarea type="text" class="form-control" name="pro_desc" placeholder="Enter project description" required><?php echo $pro_desc; ?></textarea>
                            </div>
                        </div>

                        <div class="form-group">
                            <div class="col-sm-6">
                                <input type="file" class="form-control" name="pro_image" <?php echo $image_required; ?>>
                            </div>
                        </div>
